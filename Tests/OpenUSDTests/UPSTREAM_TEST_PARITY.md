...
| `pxr/usd/sdf/testenv/testSdfParsing.testenv` | `10_bad_value.usda` | `ported` | `openUSDSDFParsingBadBoolValueFixtureThrowsTypedError`; invalid scalar bool values are rejected with `USDImportError.invalidData` |
