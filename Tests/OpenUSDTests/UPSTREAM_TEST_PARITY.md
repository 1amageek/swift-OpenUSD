...
| `pxr/usd/sdf/testenv/testSdfParsing.testenv` | `104_uniformAttributes.usda`, `113_displayName_metadata.usda`, `115_symmetricPeer_metadata.usda`, `127_varyingRelationship.usda`, `187_displayName_metadata.usda` | `partial` | `openUSDSDFParsingMetadataSyntaxFixturesReadLayers`, `openUSDSDFParsingAttributePropertySpecsReadLayer`; valid uniform, varying relationship, display name, prefix/suffix, and symmetric peer metadata syntax is accepted, and uniform connection target specs are exposed, but metadata field preservation requires broader Sdf spec modeling |
