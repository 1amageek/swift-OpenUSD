...
| `pxr/usd/sdf/testenv/testSdfParsing.testenv` | `02_simple.usda`, `07_end.usda`, `20_optionalsemicolons.usda`, `41_noEndingNewline.usda` | `partial` | `openUSDSDFParsingSimpleFixtureReadsDefAndOverPrimTransforms`, `openUSDSDFParsingEndTokenFixtureIgnoresTrailingGarbage`, `openUSDSDFParsingOptionalSemicolonsFixtureReadsSublayersAndPrimTransforms`, `openUSDSDFParsingNoEndingNewlineFixtureReadsLayer`; arbitrary field/spec preservation is blocked by the current `USDALayer` surface |
