...
| `pxr/usd/sdf/testenv/testSdfParsing.testenv` | `185_namespaced_properties.usda` | `partial` | `openUSDSDFParsingNamespacedPropertySpecsReadLayer`; namespaced attribute and relationship specs are exposed with normalized `.connect`, `.timeSamples`, and `.default` property paths, but property order list-edit values and authored values require broader Sdf field modeling |
